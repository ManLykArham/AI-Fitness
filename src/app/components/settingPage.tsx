...
function SettingPage() {
  ...
  const handleResetPassword = async () => {
    ...
    try {
      ...
      setError(
        error.message ||
          "Error resetting password. Please check your connection."
      );
      setErrorState(true);
    }
  };
  ...
  const handleUpdateDetails = async () => {
    ...
    try {
      ...
      setError(
        error.message || "Error updating details. Please check your connection."
      );
      setErrorState(true);
    }
  };
  ...
  useEffect(() => {
    const fetchUserDetails = async () => {
      try {
        ...
        setError(
          error.message ||
            "Error fetching user details. Please check your connection."
        );
        setErrorState(true);
      }
    };
