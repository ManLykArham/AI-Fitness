            ...
            <div className="mt-3">
              ...
              <div className="text-sm text-left space-y-4 h-60 overflow-y-auto">
                <p>
                  ...
                  <br />
                  By accessing and using AI Fitness, you agree to be bound by
                ...
                <p>
                  ...
                  <br />
                  AI Fitness is a comprehensive fitness tracking and guidance
                  app that includes:
                  <br />
                  - Calorie and exercise tracking
                  <br />
                  - Personalized AI-driven fitness coaching
                  <br />- Nutritional information and meal tracking
                </p>
                <p>
                  <strong>3. Third-Party Services and Data Accuracy</strong>
                  <br />
                  Our app integrates third-party databases to provide
                  nutritional and other health-related information. While we
                  strive to provide accurate data, the information may not
                  always be completely accurate or up to date. Users should
                  verify any critical information independently.
                </p>
                <p>
                  <strong>4. AI Chatbot</strong>
                  <br />
                  AI Fitness includes an AI chatbot designed to offer fitness
                  and health coaching. This AI is not a substitute for
                  professional advice from a qualified healthcare provider.
                  It&apos;s important to consult with a professional for all
                  health-related concerns.
                </p>
                <p>
                  <strong>5. Personal Data and Privacy</strong>
                  <br />
                  Your privacy is important to us. We use your data to train our
                  AI systems to provide personalized responses and improve
                ...
                <p>
                  ...
                  yourself.
                  <br />
                  It is your responsibility to ensure that the use of our app
                  does not contravene local laws or regulations.
                </p>
                <p>
                  ...
                  <br />
                  - Engaging in any activity that may interfere with or disrupt
                  the service.
                  <br />- Reproducing, duplicating, copying, selling, or
                  reselling any part of the app&apos;s services without express
                  permission.
                </p>
              </div>
              <button
