...
const Sidebar: React.FC<SidebarProps> = ({ onNavigate }) => {
  ...
  return (
    <div className="relative">
      ...
      {/* Sidebar Panel */}
      <div
        className={`md:translate-x-0 fixed top-0 left-0 h-full w-64 transform ${isOpen ? "translate-x-0" : "-translate-x-full"} transition-transform duration-300 ease-in-out z-20 bg-gray-800 text-white rounded-r-3xl`}
      >
